...
\caption{Daily maxima (orange0 and minima (blue) in the market index
  data price. (Labels on the date axis refer to the beginning of the
  calendar year.)}
\label{fig:minmax}
\end{figure}
...
and minimum price on any given day was less than $1/0.75$ on only \num{15}
days in this period, and \num{13} of those days were in~2011. Thus a
